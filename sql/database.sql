...
INSERT INTO `facility` VALUES (3, 'Your Clinic Name Here', '000-000-0000', '000-000-0000', '', '', '', '', '', '', 1, 0, 0, NULL, '', '', '', '', '', '', 1);
...
CREATE TABLE ar_activity (
  ...
  post_time      datetime      NOT NULL            COMMENT 'Physical timestamp, never user specified',
  post_date      date          DEFAULT NULL        COMMENT 'Posting date which may be user specified',
