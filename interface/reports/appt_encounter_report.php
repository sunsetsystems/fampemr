...
<?php 
 if ($res) {
  ...
  while ($row = sqlFetchArray($res)) {
   ...
   // Scan product sales for more charges.
   $drow = sqlQuery("SELECT SUM(fee) AS fee FROM drug_sales WHERE " .
   ...
   ******************************************************************/
   ...
   // TBD: The following needs to check also for TS procedures and referrals.
